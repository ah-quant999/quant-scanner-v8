...
# -*- coding: utf-8 -*-
"""
v8 孤儿模块 MARKET_ALERTS：全市场异动速览

2026-08-02 从 v6 fetch_market_alerts.py 移植，路径适配 v8 raw_data。
原 fetch_market_alerts.py 在 stock-scanner 仓，本仓保留独立维护。
用法：python fetch_orphan_market_alerts.py
输出：raw_data/market_alerts.json
"""
...
OUT = os.path.join(ROOT, "raw_data", "market_alerts.json")
