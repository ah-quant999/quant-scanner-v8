window.FINAL_RECOMMEND_DATA = {
  "update_time": "2026-09-19 10:29:41",
  "crisis_score": 32.3,
  "crisis_high": false,
  ...
  "data_degraded": false,
  "signal_edge": {
    "source": "backtest_expectancy@2026-09-19 06:42:09",
    "degraded": false,
    "effective": {
      "jinzuan": 8.676,
      "chan": 4.647,
        ...
        "alerts": [
          {
            ...
            "code": "603993",
            "name": "洛阳钼业",
            "text": "洛阳钼业(603993) 入选以来回撤 -15.6%（2026-08-17 起）"
          }
        ]
      },
      "action": "买入",
      ...
      "factor_actions": [
        {
          ...
          "adj": 0.0,
          "scored": false,
          "note": "高ROE 排名第30／signals+reasons 展示，不计分（边际 +0.68pp 弱正，不足与强源同权）"
        }
      ]
    },
    {
    ...
    "integrated": [
      {
        ...
        "scored": true,
        "adj": -0.5,
        "where": "scored 计分：final_score −0.5（weak_penalty）",
        "n_hit": 0,
        "evidence": "未回测",
