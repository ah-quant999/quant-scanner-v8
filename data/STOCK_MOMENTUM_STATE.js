window.STOCK_MOMENTUM_STATE = (function() {
  ...
  "meta": {
    ...
    "total_days": 45,
    "days_with_consensus": 42,
    "total_consensus_stocks": 421
  },
  "days": [
    {
      "date": "2026-06-08",
  ...
  "backtest": {
    "total_days": 39,
    "days_with_consensus": 38,
    "total_consensus_stocks": 385,
    "total_non_consensus": 1380,
    "consensus_returns": {
      "T+1": [],
      "T+2": [],
      "T+3": [],
  ...
  return {
    ...
    getTopConsensus: function(n) { return (n?data.topConsensusStocks:data.topConsensusStocks).slice(0,n||10); },
