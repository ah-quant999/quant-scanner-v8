window.HEALTH_CHECK = {
  ...
  "items": [
    ...
    },
    {
      ...
      "age_min": 65.0,
      "message": "更新于 今日 15:15；超过阈值 60 分钟"
    },
    {
      "id": "ETF_PULSE",
      "name": "ETF 盘中异动",
    ...
    },
    {
      ...
      "age_min": 64.2,
      "message": "更新于 今日 15:16；超过阈值 60 分钟"
    },
    {
      "id": "SECTOR_FUND_FLOW",
      "name": "板块资金流向",
    ...
    },
    {
      ...
      "page": "管线",
      "status": "ok",
      "message": "本地 HEAD 2fa50b2 / 线上 f997997 已同步（线上落后 1 commit ≤5，Pages 异步部署正常）"
    },
    {
      "id": "runner",
    ...
    },
    {
      ...
      "page": "管线",
      "status": "ok",
      "message": "本地 2fa50b2 / origin/main 2fa50b2 同步"
    },
    {
      ...
      "page": "内容审计",
      "status": "ok",
      "message": "生成时间 2026-08-13 15:44:31，最新信号发生日期 2026-07-09（历史回测样本，非陈旧指标）"
    },
    {
    ...
    },
    {
      ...
      "heal_cat": "algo_run",
      "status": "warn",
      "message": "⚠️ 逆势龙头 今日 0 只（弱市真实状态可接受，但若其他池也 0 则排查上游；若此池独立为 0 而其他池正常则不报警）"
    },
    {
      "id": "a_share_mahoro",
      "name": "国际投行信号 A股覆盖",
