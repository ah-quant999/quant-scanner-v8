window.FINAL_RECOMMEND_DATA = {
  ...
  "degrade_note": "⚠️ 数据降级：上游采集（A 批）已落后 ? 个交易日（阈值 2），本结果为「降级放行」产物 —— 排序与信号有效，但底层行情可能不是最新交易日。请勿据此判断当日市场状态。",
  "market_regime": {
    "date": "2026-09-18",
    "regime": "grind",
    "open": true,
        ...
        "alerts": [
          {
            ...
            "code": "301308",
            "name": "江波龙",
            "text": "江波龙(301308) 连续 5 日稳居严格共识（高质量）"
          }
        ]
      },
      "action": "买入",
        ...
        "alerts": [
          {
            ...
            "code": "300857",
            "name": "协创数据",
            "text": "协创数据(300857) 于 2026-09-02 跌出共识（曾连续 2 日）"
          }
        ]
      },
      "action": "买入",
