...
# 🔴 2026-09-13 主人令扩档：[5,10,20,30,45,60,75,90] → +180/+250。
#   主人原话：「马上把所有接入算法链的选股策略都按5、10、20、30、45、60、75、90、180、250日
#   的跟踪回测」。**与回测脚本 HOLD_LADDER 同源**（各写一套必然漂移）。
#   ⚠️ 180/250 档初期 samples=0 属正常（跟踪池刚起跑），前端显示「累积中」。
HORIZONS = [5, 10, 20, 30, 45, 60, 75, 90, 180, 250]
